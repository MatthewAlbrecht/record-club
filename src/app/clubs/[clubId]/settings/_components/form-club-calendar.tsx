		...
		<div className="lg:flex lg:h-full lg:flex-col">
			<header className="flex items-center justify-between border-b border-gray-200  py-4 lg:flex-none">
				...
				<div className="relative flex rounded-md bg-white shadow-sm">
					...
					<button
						type="button"
						className="flex h-9 items-center justify-center rounded-r-md border-y border-r border-gray-300 pl-1 text-gray-400 hover:text-gray-500 focus:relative w-9 pl-0 md:hover:bg-gray-50"
					>
					...
					<div className="ml-4 flex items-center">
						{/* <DropdownMenu>
							...
							<DropdownMenuContent>
								...
								<DropdownMenuItem>Year view</DropdownMenuItem>
							</DropdownMenuContent>
						</DropdownMenu>
